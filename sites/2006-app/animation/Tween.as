 ...
 */
	function Tween (target:Object, tweenPropList:Object, tweenDuration:Number, easingFunction:Function,startFlag:Boolean)
	{
		_oTarget = target;
		...
		if(tweenPropList!=undefined) for (var a in tweenPropList) setTweenProperty (tweenPropList[a].prop, tweenPropList[a].start, tweenPropList[a].end);
	...
	public function start ():Void
	{
		...
		_tweenInterval = setInterval (Proxy.create(this, update), 10);
