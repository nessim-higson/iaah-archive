var __iaahPayloadBase=(function(){var m=location.pathname.match(/^(.*\/sites\/2014-work\/)/);return (m?m[1]:'/')+ 'assets/payload/';})();
var IAAH = IAAH || {};
...
IAAH.templates = {
    ...
    introPanelLargeMessage: '' +
        '<div class="large-message">' +
            '<div class="copy">' +
                '<img nopin="nopin" src="'+__iaahPayloadBase+'1/0/833/3258214/intropanel-headline.png" width="670" height="63" alt="40 Days / 40 Projects" />' +
    ...
    //                             // '<img src="'+__iaahPayloadBase+'1/0/833/3258214/facebook-icon-{{iconsColor}}.png" width="10" height="25" />' +
    //                     '</div>' +
    //                 '{{#if isTouchDevice}}</a>{{/if}}' +
    //                 '{{#if isTouchDevice}}<a href="{{pinterestURL}}" target="_blank">{{/if}}' +
    //                     '<div class="social-icon pinterest {{iconsColor}}">' +
    //                             // '<img src="'+__iaahPayloadBase+'1/0/833/3258214/pinterest-icon-{{iconsColor}}.png" width="15" height="25" />' +
    //                     '</div>' +
    //                 '{{#if isTouchDevice}}</a>{{/if}}' +
    //             '</div>' +
    //             '{{#if includeWidgets}}' +
    ...
    //                         '<div class="social-widget pinterest last"><a href="{{pinterestURL}}" target="_blank"><img src="'+__iaahPayloadBase+'1/0/833/3258214/pinterest-widget2.png" width="57" height="20" alt="Follow Me on Pinterest" /></a></div>' +
    //                     '{{else}}' +
    ...
    //                         '</div>' +
    //                         '<div class="social-widget facebook"><a href="{{facebookURL}}" target="_blank"><img src="'+__iaahPayloadBase+'1/0/833/3258214/facebook-widget-share_26.png" width="60" height="20"></a></div>' +
